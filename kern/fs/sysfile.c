...
/* sysfile_fsync - 同步文件(写回磁盘) */
int
sysfile_fsync(int fd) {
    return file_fsync(fd);
}

/* sysfile_chdir - 改变当前目录 */
int
...
/* sysfile_getdirentry - 获得目录下的文件条目 */
int
